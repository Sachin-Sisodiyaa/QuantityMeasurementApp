...
import com.app.authservice.auth.AuthResponse;
import com.app.authservice.auth.AuthConfigResponse;
import com.app.authservice.auth.LoginRequest;
import com.app.authservice.auth.RegisterRequest;
import com.app.authservice.auth.UserProfileResponse;
import com.app.authservice.exception.AuthException;
...
public class AuthController {
    ...
    @GetMapping("/config")
    @Operation(summary = "Get public authentication configuration")
    public ResponseEntity<AuthConfigResponse> getConfig() {
        return ResponseEntity.ok(new AuthConfigResponse(googleOauthEnabled));
    }
}
