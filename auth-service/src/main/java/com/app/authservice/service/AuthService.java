...
import com.app.authservice.model.AuthProvider;
import com.app.authservice.model.UserEntity;
import com.app.authservice.model.UserRole;
...
public class AuthService {
    ...
    public AuthResponse register(RegisterRequest request) {
        ...
        if (userRepository.existsByEmailIgnoreCase(email)) {
            throw new AuthException("User already exists with email: " + email, HttpStatus.CONFLICT);
        }
