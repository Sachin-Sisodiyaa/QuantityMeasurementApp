...
import com.app.measurementservice.service.MeasurementCalculator.MeasurementResult;
...
public class QuantityMeasurementServiceImpl implements IQuantityMeasurementService {
    ...
    @Override
    @Transactional
    public long clearHistoryByMeasurementType(String measurementType) {
        return repository.deleteByThisMeasurementType(measurementType);
    }
